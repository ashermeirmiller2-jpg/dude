...
export const SENTENCES = [
  ...
  {
    id: "s021",
    aramaic: "אִיכָּא דְּאָמְרִי הָכִי",
    translation: "There are those who say so",
    transliteration: "ikka de'amri hachi",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w036", "w009", "w001", "w021"],
    chunk_ids: ["c011"],
    discourse_function: "statement",
    difficulty_tier: 2,
    global_shown_count: 0,
  ...
  {
    id: "s022",
    aramaic: "בִּשְׁלָמָא לְדִבְרֵי",
    translation: "Granted, according to the words of",
    transliteration: "bishlama ledivrei",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w052", "w058"],
  ...
  },
  {
    id: "s023",
    aramaic: "מַאי קָשֶׁה",
    translation: "What is difficult?",
    transliteration: "mai kasheh",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w004", "w061"],
  ...
  {
    id: "s024",
    aramaic: "שְׁמַע מִינַּהּ תְּלַת",
    translation: "Learn three things from this",
    transliteration: "shema minah telt",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w028", "w066"],
  ...
  {
    id: "s025",
    aramaic: "מִדְּאִיתְנִי",
    translation: "Since it was taught",
    transliteration: "middeitni",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w065", "w064"],
  ...
  {
    id: "s026",
    aramaic: "לְמַאי הִלְכְתָא",
    translation: "For what practical law?",
    transliteration: "lemai hilcheta",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w063"],
  ...
  {
    id: "s027",
    aramaic: "גְּמַר וְאָמַר",
    translation: "He finished studying and said",
    transliteration: "gemar ve'amar",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w070", "w016", "w001"],
    chunk_ids: [],
    discourse_function: "statement",
    difficulty_tier: 3,
    global_shown_count: 0,
  ...
  {
    id: "s028",
    aramaic: "אֲמַר לֵיהּ רַב",
    translation: "Rav said to him",
    transliteration: "amar leih rav",
    sefaria_ref: "Multiple occurrences",
    tractate: "Berakhot",
    daf: "2a",
    word_ids: ["w067", "w002"],
  ...
  {
    id: "s029",
    aramaic: "מַאי בֵּינַיְיהוּ דְּרַבָּנַן",
    translation: "What is the practical difference between them according to the Rabbis?",
    transliteration: "mai beinaihu derabbanan",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w004", "w068", "w009", "w026"],
    chunk_ids: [],
    discourse_function: "question",
    difficulty_tier: 3,
    global_shown_count: 0,
  ...
  {
    id: "s030",
    aramaic: "הָכִי נָמֵי אִיכָּא",
    translation: "So too there is",
    transliteration: "hachi nami ikka",
    sefaria_ref: "Multiple occurrences",
    tractate: "General",
    daf: null,
    word_ids: ["w059", "w036"],
